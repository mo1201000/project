...
class App:
    def __init__(self, window, window_title, video_source=0):
        ...
        self.btn_snapshot=tk.Button(window, text="SCEERNSHOT", command=self.snapshot, width='15',height='4',bg='orange',fg='white')
        self.btn_snapshot.pack(side=tk.LEFT)

        #video control buttons

        self.btn_start=tk.Button(window, text='START', command=self.open_camera, width='15',height='4',bg='orange',fg='white')
        self.btn_start.pack(side=tk.LEFT)
        

        self.btn_Reset=tk.Button(window, text='RESET', command= self.update,width='15',height='4',bg='orange',fg='white')
        self.btn_Reset.pack(side=tk.LEFT)

        self.btn_stop=tk.Button(window, text='STOP', command=self.close_camera,width='15',height='4',bg='orange',fg='white')
        self.btn_stop.pack(side=tk.LEFT)
        

        # quit button
        self.btn_quit=tk.Button(window, text='QUIT', command=quit,width='15',height='4',bg='orange',fg='white')
...
class ElapsedTimeClock:
    def __init__(self,window):
        self.T=tk.Label(window,text='00:00:00',font=('times', 20, 'bold'), bg='green',fg='red')
